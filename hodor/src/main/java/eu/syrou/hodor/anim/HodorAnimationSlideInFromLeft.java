 ...
 */
public class HodorAnimationSlideInFromLeft extends HodorAnimation {
    @Override
    public void inAnimation(View view, long milliseconds) {
        HodorMoves.slideInFromLeft(view, milliseconds);
    }

    @Override
    public void outAnimation(View view, long milliseconds) {
        HodorMoves.slideOutToRight(view,milliseconds);
    }
}
